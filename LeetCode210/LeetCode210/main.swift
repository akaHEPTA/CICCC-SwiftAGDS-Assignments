...
//  LeetCode210
//
//  Created by Richard Cho on 2020-03-04.
...
class Solution {
    func findOrder(_ numCourses: Int, _ prerequisited: [[Int]]) -> Array<Int> {
        ...
        func checkDependency() -> Array<Int> {
            let q = Queue<Int>()
            ...
            while !q.isEmpty() {
                ...
                if rc[first] != 0 { return Array<Int>() }
            ...
            if checked.contains(false) { return Array<Int>() }
            return res
        }
        
        if !rc.contains(0) { return Array<Int>() }
        else {
