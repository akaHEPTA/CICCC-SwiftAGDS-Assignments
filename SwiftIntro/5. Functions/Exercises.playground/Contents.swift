...
var word = "bologna"
var c = String(word.reversed())
print(c.remove(at: c.startIndex))
//: __Problem 2__
//:
...
combineLastCharacters(strings: nonsenseArray)
...
var movies:Dictionary<String,String> = [ "Boyhood":"Richard Linklater",
